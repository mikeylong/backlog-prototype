...
(1..10).each { |i| Objective.create(title: "#{objective_titles[(rand(objective_titles.length))]} #{i}", description: "Enter a description", program_id: 1, plan_id: 1, cost: (rand(10).to_i + 1), value: (rand(10).to_i + 1)) }
